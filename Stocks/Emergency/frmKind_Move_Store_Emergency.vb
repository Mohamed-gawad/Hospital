...
Public Class frmKind_Move_Store_Emergency
    ...
    End Sub
    Private Sub frmKind_Move_Store_Emergency_Load(sender As Object, e As EventArgs) Handles Me.Load
        Label3.Left = 0
    ...
    Private Sub frmKind_Move_Store_Emergency_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        StockID = 3
    End Sub
End Class