...
Public Class frmDrage_Store_Emergency
    Dim fin As Boolean
    ...
    Sub Save_To_Stock()
        ...
        Binding()
    End Sub
    Private Sub frmDrage_Store_Emergency_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        Myconn.Fillcombo("select * from Drugs order by Drug_Name", "Drugs", "Drug_ID", "Drug_Name", Me, cbo_Drug)
        StockID = 3
    End Sub
    Private Sub frmDrage_Store_Emergency_KeyUp(sender As Object, e As KeyEventArgs) Handles Me.KeyUp
        ...
        End If
    End Sub
    Private Sub frmDrage_Store_Emergency_Load(sender As Object, e As EventArgs) Handles Me.Load
        Label1.Left = 0
