Public Class frmBills_Add_Drage_Emergency
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        Fillgrd()
    End Sub
    Private Sub frmBills_Add_Drage_Emergency_Load(sender As Object, e As EventArgs) Handles Me.Load
        Label5.Left = 0
        Label5.Width = Me.Width
        StockID = 3
    End Sub

    Private Sub frmBills_Add_Drage_Emergency_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        StockID = 3
    End Sub
End Class