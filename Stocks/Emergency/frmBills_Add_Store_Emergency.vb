Public Class frmBills_Add_Store_Emergency
    ...
    Private Sub frmBills_Add_Store_Emergency_Load(sender As Object, e As EventArgs) Handles Me.Load
        Label5.Left = 0
    ...
    Private Sub frmBills_Add_Store_Emergency_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        StockID = 3
    End Sub
End Class