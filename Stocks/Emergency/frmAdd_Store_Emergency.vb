...
Public Class frmAdd_Store_Emergency
    Dim fin As Boolean
    ...
    Sub Save_To_Stock()
        ...
        With Myconn.cmd.Parameters
            ...
            .Add("@Drug_Sales_ID", SqlDbType.Int).Value = DBNull.Value ' رقم السجل في حالة الاضافة من الصيدلية من اجل الحذف والتعديل من الصيدلية
    ...
    End Sub
    Private Sub frmAdd_Store_Emergency_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        StockID = 3
        fin = False
    ...
    Private Sub frmAdd_Store_Emergency_KeyUp(sender As Object, e As KeyEventArgs) Handles Me.KeyUp
        ...
        End If
    End Sub
    Private Sub frmAdd_Store_Emergency_Load(sender As Object, e As EventArgs) Handles Me.Load
        Label1.Left = 0
