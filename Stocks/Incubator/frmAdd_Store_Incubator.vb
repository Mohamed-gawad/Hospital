...
Public Class frmAdd_Store_Incubator
    Dim fin As Boolean
    ...
    End Sub
    Private Sub frmAdd_Store_Incubator_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        StockID = 4
        fin = False
        ...
        fin = True
    End Sub
    Private Sub frmAdd_Store_Incubator_KeyUp(sender As Object, e As KeyEventArgs) Handles Me.KeyUp
        ...
        End If
    End Sub
    Private Sub frmAdd_Store_Incubator_Load(sender As Object, e As EventArgs) Handles Me.Load
        Label1.Left = 0
