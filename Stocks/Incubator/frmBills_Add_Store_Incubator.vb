Public Class frmBills_Add_Store_Incubator
    ...
    Sub Fillgrd() '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''لتعبئة الداتا جريد بالبيانات 
        Try
            ...
            Myconn.Filldataset("Select a.Bill_ID,b.Supplier_Name,a.bill_date,sum(a.Total) As Total,count(Drug_ID) As count_Drug1,isnull(c.back,0) As back,isnull(c.count_Drug,0) As count_Drug,
                                ...
                                left join (select Bill_ID,State ,sum(Total) as back,count(Drug_ID) as count_Drug from [dbo].[Stocks_Purchases] group by Bill_ID,State,Stock_ID having State ='false' and Stock_ID = " & StockID & ") c
    ...
    End Sub
    Private Sub frmBills_Add_Store_Incubator_Load(sender As Object, e As EventArgs) Handles Me.Load
        Label5.Left = 0
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        Fillgrd()
    End Sub
    Private Sub frmBills_Add_Store_Incubator_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        StockID = 4
    End Sub
End Class