Public Class frmKind_Move_Store_Incubator
    ...
    End Sub
    Private Sub frmKind_Move_Store_Incubator_Load(sender As Object, e As EventArgs) Handles Me.Load
        Label3.Left = 0
    ...
    Private Sub cbo_Drug_Enter(sender As Object, e As EventArgs) Handles cbo_Drug.Enter
        Myconn.langAR()
    End Sub
    Private Sub frmKind_Move_Store_Incubator_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        StockID = 4
    End Sub
End Class