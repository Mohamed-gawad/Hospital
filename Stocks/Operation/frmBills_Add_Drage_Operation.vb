Public Class frmBills_Add_Drage_Operation
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        Fillgrd()
    End Sub
    Private Sub frmBills_Add_Drage_Operation_Load(sender As Object, e As EventArgs) Handles Me.Load
        Label5.Left = 0
        Label5.Width = Me.Width
        StockID = 2
    End Sub

    Private Sub frmBills_Add_Drage_Operation_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        StockID = 2
    End Sub
End Class