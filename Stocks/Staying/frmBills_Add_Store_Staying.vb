Public Class frmBills_Add_Store_Staying
    ...
    End Sub
    Private Sub frmBills_Add_Store_Staying_Load(sender As Object, e As EventArgs) Handles Me.Load
        Label5.Left = 0
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        Fillgrd()
    End Sub
    Private Sub frmBills_Add_Store_Staying_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        StockID = 5
    End Sub
End Class