Public Class frmKind_Move_Store_Staying
    ...
    End Sub
    Private Sub frmKind_Move_Store_Staying_Load(sender As Object, e As EventArgs) Handles Me.Load
        Label3.Left = 0
    ...
    Private Sub frmKind_Move_Store_Staying_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        StockID = 5
    End Sub
End Class