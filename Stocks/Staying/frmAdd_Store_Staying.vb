...
Public Class frmAdd_Store_Staying
    Dim fin As Boolean
    ...
    End Sub
    Private Sub frmAdd_Store_Staying_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        StockID = 5
        fin = False
        ...
        fin = True
    End Sub
    Private Sub frmAdd_Store_Staying_KeyUp(sender As Object, e As KeyEventArgs) Handles Me.KeyUp
        ...
        End If
    End Sub
    Private Sub frmAdd_Store_Staying_Load(sender As Object, e As EventArgs) Handles Me.Load
        Label1.Left = 0
